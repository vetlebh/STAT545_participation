...
![](cm006-exercise_files/figure-markdown_github/unnamed-chunk-2-1.png) The plot is not showing the points/plot!
...
``` r
b + geom_violin() + geom_jitter(alpha=0.4)
```
...
![](cm006-exercise_files/figure-markdown_github/unnamed-chunk-21-2.png)
